...
exports.listAnesthesiologistsController = listAnesthesiologistsController;
exports.getAnesthesiologistByIdController = getAnesthesiologistByIdController;
const anesthesiologistsService = __importStar(require("./anesthesiologists.service"));
...
async function listAnesthesiologistsController(req, res, next) {
    try {
...
async function getAnesthesiologistByIdController(req, res, next) {
    try {
